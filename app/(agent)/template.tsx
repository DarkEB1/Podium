...
// GL1 — Agent route-group template. Next.js remounts `template.tsx` on every
...
/**
 * A "detail" entry is any route nested below a section root (2+ path segments,
 * e.g. `/agents/abc-123`). Section roots (`/dashboard`, `/agents`) use the
