        ...
        {options.map((option) => {
          ...
          return (
            <button
              ...
              className={cn(
                "group flex flex-col items-start gap-1 rounded-xl border bg-card p-4 text-left outline-none transition-colors",
                "hover:border-accent/60 focus-visible:ring-3 focus-visible:ring-ring/50",
                selected
